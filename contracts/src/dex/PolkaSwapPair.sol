...
/// @title PolkaSwapPair — AMM liquidity pair with constant product formula
contract PolkaSwapPair is ERC20, ReentrancyGuard {
    ...
    constructor() ERC20("PolkaSwap LP", "PSLP") {
        factory = msg.sender;
    }
    ...
    function swap(uint256 amount0Out, uint256 amount1Out, address to) external nonReentrant {
        ...
        require(balance0Adjusted * balance1Adjusted >= uint256(_reserve0) * uint256(_reserve1) * 1000000, "Pair: K");
